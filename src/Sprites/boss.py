...
class Boss(Enemy):
  def __init__(self, spritesheet_filename, width, height, rows, columns, speed_h, speed_v, cooldown, hit_points):
    ...
    Enemy.__init__(self, spritesheet_filename, width, height, rows, columns, speed_h, speed_v, cooldown, hit_points)

    self.direction = -1

  def fire(self):
    # Bullet(spritesheet_filename, width, height, rows, columns, speed, direction)
